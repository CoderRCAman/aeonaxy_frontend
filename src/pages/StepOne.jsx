  ...
  return (
    <section className="flex flex-col min-h-screen p-2">
      ...
      <form
        ...
        className="container mx-auto flex flex-col flex-grow justify-center items-center"
      >
        <input
        ...
        <div>
          ...
          <div className="space-y-5 mt-10">
            ...
            <div className=" flex-col sm:flex-row justify-center items-center flex gap-10">
              <div
                onClick={() => fileRef.current.click()}
                className="h-40 border-dashed w-40 rounded-full border-[3px] border-neutral-300 flex justify-center items-center"
              >
                {file ? (
                  <img
              ...
              <div className="mt-4 space-y-6 flex flex-col justify-center items-center sm:items-start">
                <div className="flex">
                  <div className="py-2 px-3 font-semibold text-sm border border-neutral-300 rounded-md">
                    Choose image
                  </div>
                </div>
          ...
          <div className="mt-12">
            <h1 className="text-xl font-bold">Add your location</h1>
            <div className="mt-5">
              <input
                value={location}
                onChange={(e) => setLocation(e.target.value)}
                placeholder="Enter a location"
                className="outline-none border-b border-neutral-300 pb-2 w-full placeholder:font-semibold placeholder:text-neutral-300 "
              />
            </div>
          </div>
          ...
          <div className="mt-12">
            {loading ? (
              ...
              <button
                disabled={isDisabled()}
                className="w-52 py-2 rounded-md text-white font-semibold bg-pink-500 disabled:bg-pink-300"
              >
                Next
              </button>
            )}
            <p className="font-semibold text-neutral-400 text-xs ml-7 mt-1">
              or Press RETURN
            </p>
          </div>
        </div>
